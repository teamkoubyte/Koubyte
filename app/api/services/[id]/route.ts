...
export async function GET(request: Request, { params }: RouteParams) {
  try {
    ...
    return createErrorResponse(error, 'Fout bij ophalen service', 500)
  }
}
...
export async function PATCH(request: Request, { params }: RouteParams) {
  try {
    ...
    return createErrorResponse(error, 'Fout bij bijwerken service', 500)
  }
}
...
export async function DELETE(request: Request, { params }: RouteParams) {
  try {
    ...
    return createErrorResponse(error, 'Fout bij verwijderen service', 500)
  }
}
