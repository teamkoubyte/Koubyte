...
export default async function AdminPage() {
  ...
  return (
    <div className="container mx-auto max-w-7xl py-8 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-slate-600">Totaal Gebruikers</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-slate-600">Afspraken (In Behandeling)</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-3xl font-bold text-blue-600">{pendingAppointments}</div>
            <div className="text-sm text-slate-500">van {totalAppointments} totaal</div>
          </CardContent>
        </Card>

        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-slate-600">Reviews te Beoordelen</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-slate-600">Bestellingen</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      {/* Snelle Links */}
      <h2 className="text-2xl font-bold text-slate-900 mb-4">Beheer</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <Link href="/admin/users">
          <Card className="hover:shadow-xl transition-all cursor-pointer border-2 hover:border-purple-500 h-full">
            ...
            <CardContent>
              <p className="text-slate-600">Beheer gebruikers en accounts</p>
              <div className="mt-3 text-sm text-slate-500">{totalUsers} geregistreerd</div>
            </CardContent>
          </Card>
        </Link>
        ...
        <Link href="/admin/orders">
          <Card className="hover:shadow-xl transition-all cursor-pointer border-2 hover:border-green-500 h-full">
            ...
            <CardContent>
              <p className="text-slate-600">Bekijk en verwerk bestellingen</p>
              <div className="mt-3 text-sm text-slate-500">{totalOrders} totaal</div>
            </CardContent>
          </Card>
        </Link>
        ...
        <Link href="/admin/messages">
          <Card className="hover:shadow-xl transition-all cursor-pointer border-2 hover:border-orange-500 h-full">
            ...
            <CardContent>
              <p className="text-slate-600">Contact berichten beheren</p>
            </CardContent>
          </Card>
        </Link>
        ...
        <Link href="/admin/reviews">
          <Card className="hover:shadow-xl transition-all cursor-pointer border-2 hover:border-yellow-500 h-full">
            ...
            <CardContent>
              <p className="text-slate-600">Modereer klant reviews</p>
              {pendingReviews > 0 && (
                <div className="mt-3 inline-block bg-yellow-100 text-yellow-700 px-3 py-1 rounded-full text-sm font-semibold">
